...
<style>
	*{
	...
	#bg{
		background: url(img/news2_bg.jpg) no-repeat;
...
<script>
	window.onload = function(){
		...
		var aNews = document.getElementsByClassName('轻小说情报');
...
<nav>
	<ul>
		...
		<li><a class="active" href="news3">轻小说情报</a></li>
