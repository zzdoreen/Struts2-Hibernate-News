...
<style>
	*{
	...
	#bg{
		background: url(img/news4_bbg.jpg) no-repeat;
...
window.onload = function(){
	...
	var aNews = document.getElementsByClassName('动漫周边');
...
<nav>
	<ul>
		...
		<li><a class="active" href="news4">动漫周边</a></li>
	</ul>
</nav>
<section>
	<ul id="news">
